          ...
          <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
            ...
            <div className="flex items-center lg:order-2">
              {!UserActive && (
                <Link
                  to="login"
                  className="text-gray-800 dark:text-white hover:bg-gray-500 hover:text-white focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 mr-2 dark:hover:bg-gray-700 focus:outline-none dark:focus:ring-gray-800"
                >
                  Log in
                </Link>
              )}
              ...
              {!UserActive && (
                <Link
                  to="signin"
                  className="text-black bg-primary-700 hover:bg-primary-800 hover:bg-gray-500 hover:text-white  font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 mr-2 dark:bg-primary-600 dark:hover:bg-primary-700 focus:outline-none dark:focus:ring-primary-800"
                >
                  Sign in
                </Link>
              )}
            ...
            >
              <ul className="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
                ...
                <li>
                  <Link
                    to="features"
                    className="block py-2 pr-4 pl-3 text-gray-700 border-b border-gray-100 hover:bg-gray-200 lg:hover:bg-transparent lg:border-0 lg:hover:text-primary-700 lg:p-0 dark:text-gray-400 lg:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white lg:dark:hover:bg-transparent dark:border-gray-700 hover:text-blue-800"
                  >
                    Features
                  </Link>
                </li>
                ...
                <div className="relative flex items-center cursor-pointer" onClick={cartItems}>
                  ...
                  <p className="absolute top-3 left-8 hidden md:inline md:text-sm hover:underline">
                    Cart
                  </p>
                </div>
              </ul>
